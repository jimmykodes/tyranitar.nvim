...
local c = require('tyranitar.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "SpellCap", { fg = 'NONE', bg = 'NONE', sp = c.ground_brown, undercurl=true, })
  ...
  hl(0, "PmenuSel", { fg = 'NONE', bg = c.ui2_green })
  hl(0, "WildMenu", { fg = c.fg, bg = c.ui2_green })
  ...
  hl(0, "Visual", { fg = 'NONE', bg = c.ui_green })
  hl(0, "VisualNOS", { fg = c.alt_fg, bg = c.alt_bg })
  ...
  hl(0, "QuickFixLine", { fg = 'NONE', bg = c.ui2_green })
  ...
  hl(0, "Search", { fg = 'NONE', bg = c.ui5_green })
  hl(0, "IncSearch", { fg = 'NONE', bg = c.ui2_yellow })
  hl(0, "Substitute", { fg = 'NONE', bg = c.ui2_yellow })
  hl(0, "MoreMsg", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "Question", { fg = c.rock_brown, bg = 'NONE' })
  ...
  hl(0, "Character", { fg = c.rock_brown, bg = 'NONE' })
  ...
  hl(0, "Type", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "Function", { fg = c.ground_brown, bg = 'NONE' })
  ...
  hl(0, "StorageClass", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "Structure", { fg = c.vivid_green, bg = 'NONE' })
  ...
  hl(0, "SpecialChar", { fg = c.rock_brown, bg = 'NONE' })
  ...
  hl(0, "Special", { fg = c.rock_brown, bg = 'NONE' })
  ...
  hl(0, "TSEnvironmentName", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "TSVariableBuiltin", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "TSConstMacro", { fg = c.vivid_blue, bg = 'NONE' })
  hl(0, "TSTypeBuiltin", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "TSAnnotation", { fg = c.blue, bg = 'NONE' })
  hl(0, "TSNamespace", { fg = c.vivid_green, bg = 'NONE' })
  ...
  hl(0, "TSAttribute", { fg = c.vivid_green, bg = 'NONE' })
  ...
  hl(0, "TSURI", { fg = c.vivid_green, bg = 'NONE', underline=true, })
  hl(0, "TSMath", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "TSLiteral", { fg = c.rock_brown, bg = 'NONE' })

  -- markdown
  hl(0, "markdownBlockquote", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "markdownCode", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "markdownCodeBlock", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "markdownCodeDelimiter", { fg = c.rock_brown, bg = 'NONE' })
  ...
  hl(0, "markdownBoldItalic", { fg = c.ground_brown, bg = 'NONE', bold=true, italic=true, })
  ...
  hl(0, "markdownUrl", { fg = c.vivid_green, bg = 'NONE', underdotted=true, })
  hl(0, "markdownLinkText", { fg = c.blue, bg = 'NONE' })
  hl(0, "markdownFootnote", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "markdownFootnoteDefinition", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "markdownEscape", { fg = c.ground_brown, bg = 'NONE' })
  ...
  -- Telescope
  hl(0, "TelescopeSelection", { fg = 'NONE', bg = c.ui2_green })
  hl(0, "TelescopeSelectionCaret", { fg = c.red, bg = c.ui2_green })
  ...
  hl(0, "TelescopePromptTitle", { fg = c.ui_yellow, bg = 'NONE', bold=true, })
  hl(0, "TelescopeResultsTitle", { fg = c.ui_yellow, bg = 'NONE', bold=true, })
  hl(0, "TelescopePreviewTitle", { fg = c.ui_yellow, bg = 'NONE', bold=true, })
  ...
  hl(0, "NvimTreeSpecialFile", { fg = c.rock_brown, bg = 'NONE' })
  ...
  hl(0, "NvimTreeSymlink", { fg = c.vivid_green, bg = 'NONE' })
  ...
  hl(0, "LirSymLink", { fg = c.vivid_green, bg = 'NONE' })
  ...
  hl(0, "DashboardFooter", { fg = c.vivid_green, bg = 'NONE' })
  ...
  hl(0, "BookmarkAnnotationSign", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "BookmarkLine", { fg = c.ui2_green, bg = 'NONE' })
  hl(0, "BookmarkAnnotationLine", { fg = c.ui2_green, bg = 'NONE' })

  -- Bqf
  hl(0, "BqfPreviewBorder", { fg = c.fg, bg = 'NONE' })
  hl(0, "BqfPreviewRange", { fg = 'NONE', bg = c.ui2_green })

  -- Cmp
  hl(0, "CmpItemAbbrDeprecated", { fg = c.gray, bg = 'NONE', strikethrough=true, })
  hl(0, "CmpItemAbbrMatch", { fg = c.ui3_green, bg = 'NONE' })
  hl(0, "CmpItemAbbrMatchFuzzy", { fg = c.ui3_green, bg = 'NONE' })
  hl(0, "CmpItemKindFunction", { fg = c.ui_purple, bg = 'NONE' })
  hl(0, "CmpItemKindMethod", { fg = c.ui_purple, bg = 'NONE' })
  hl(0, "CmpItemKindConstructor", { fg = c.ui_yellow, bg = 'NONE' })
  hl(0, "CmpItemKindClass", { fg = c.ui_yellow, bg = 'NONE' })
  hl(0, "CmpItemKindEnum", { fg = c.ui_yellow, bg = 'NONE' })
  hl(0, "CmpItemKindEvent", { fg = c.info, bg = 'NONE' })
  hl(0, "CmpItemKindInterface", { fg = c.ui_yellow, bg = 'NONE' })
  hl(0, "CmpItemKindStruct", { fg = c.ui_yellow, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindModule", { fg = c.vivid_green, bg = 'NONE' })
  ...
  -- Packer
  hl(0, "packerString", { fg = c.ui_yellow, bg = 'NONE' })
  hl(0, "packerHash", { fg = c.ui4_green, bg = 'NONE' })
  ...
  hl(0, "packerStatusSuccess", { fg = c.ui4_green, bg = 'NONE' })
  ...
  hl(0, "NotifyINFOBorder", { fg = c.ui_green, bg = 'NONE' })
  ...
  hl(0, "NotifyINFOIcon", { fg = c.ui4_green, bg = 'NONE' })
  ...
  hl(0, "NotifyINFOTitle", { fg = c.ui4_green, bg = 'NONE' })
  ...
  hl(0, "debugPc", { fg = 'NONE', bg = c.ui5_green })
  ...
  -- Language
  hl(0, "xmlTag", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "xmlTagName", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "xmlEndTag", { fg = c.vivid_green, bg = 'NONE' })
  hl(0, "yamlPlainScalar", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "yamlTSField", { fg = c.blue, bg = 'NONE' })
  hl(0, "luaFunc", { fg = c.ground_brown, bg = 'NONE' })
  ...
  hl(0, "htmlLink", { fg = c.rock_brown, bg = 'NONE', underline=true, })
  hl(0, "cssBraces", { fg = c.fg, bg = 'NONE' })
  hl(0, "cssInclude", { fg = c.purple, bg = 'NONE' })
  hl(0, "cssTagName", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "cssClassName", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "cssPseudoClass", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "cssPseudoClassId", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "cssPseudoClassLang", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "cssIdentifier", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "cssProp", { fg = c.fg, bg = 'NONE' })
  hl(0, "cssDefinition", { fg = c.fg, bg = 'NONE' })
  hl(0, "cssAttr", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "cssAttrRegion", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "cssColor", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "cssFunction", { fg = c.purple, bg = 'NONE' })
  hl(0, "cssFunctionName", { fg = c.ground_brown, bg = 'NONE' })
  hl(0, "cssVendor", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "cssValueNumber", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "cssValueLength", { fg = c.rock_brown, bg = 'NONE' })
  hl(0, "cssUnitDecorators", { fg = c.rock_brown, bg = 'NONE' })
